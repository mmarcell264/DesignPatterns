use crate::facade::{account, security_code};

use super::{account::Account, ledger::Ledger, notification::Notification, security_code::SecurityCode, wallet::Wallet};

/// Facade hides a complex logic behind the API.
pub struct WalletFacede {
    account: Account,
    wallet: Wallet,
    code: SecurityCode,
    notifacition: Notification,
    ledger: Ledger
}
...
impl WalletFacede {
    ...
    pub fn add_money_to_wallet(
        ...
        self.notifacition.send_wallet_credit_notification();
    ...
    pub fn deduct_money_from_wallet(
        ...
        self.notifacition.send_wallet_debit_notification();
